...
class AddImei extends React.Component {
	constructor(props) {
		super(props);
	...
	addImei = () => {
		let that = this;
		axios.post('/ajax/imeiAdd', {...this.state.imei, token: Cookies.get('__token')}).then(function(data){
						...
						<div className="panel-body">
							<div className="form-horizontal">										
								...
								<div className="form-group text-center">
									<button type="submit" className="btn btn-w-md btn-primary" onClick={this.addImei}>确认</button>
